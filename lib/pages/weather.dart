...
class WeatherCast extends StatefulWidget {
  const WeatherCast({Key? key}) : super(key: key);

  @override
  _WeatherCastState createState() => _WeatherCastState();
}

class _WeatherCastState extends State<WeatherCast> {
  @override
